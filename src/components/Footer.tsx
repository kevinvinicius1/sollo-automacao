...
export default function Footer() {
  return (
    <footer className="border-t-4 border-accent-500 bg-brand-900 text-brand-100 md:flex">
      ...
      {/* Coluna bordô das redes sociais */}
      <div className="flex items-center justify-center gap-6 bg-accent-600 px-6 py-5 text-white md:w-28 md:flex-col md:gap-8 md:py-12">
        <a
